...
<div class='row justify-content-left'>
    <div class="col">
        ...
        <fieldset>
            ...
            echo $this->Form->input('atividade', ['required', 'label' => ['text' => 'Atividade', 'class' => 'col-1'], 'div' => 'form-group row', 'class' => 'form-control col-10', 'between' => "<div class = 'form-inline col-11'>", 'after' => '</div>']);
            ?>
        </fieldset>
        <div class='row justify-content-center'>
            <div class='col-auto'>
