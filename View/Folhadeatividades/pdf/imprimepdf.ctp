...
<h2 style="text-align:center; line-height: 80%; margin: 0">
    ...
    <br />
    <span style="font-size: 100%">Folha de ativiades do(a) estagiário(a) <?= $estagio["Estagiario"]["Aluno"]["nome"] ?></span>
</h2>

<p style="font-size: 90%">DRE: <?= $estagio['Estagiario']['registro'] ?>
    Telefone: <?= $estudante['Aluno']['celular'] ?>
    E-mail: <?= $estudante['Aluno']['email'] ?>
</p>
...
<div>
    <table class='table table-bordered'>
        ...
        <tbody>
            <tr>
                ...
                <td><?= $estagio['Estagiario']['Supervisor']['cress'] = isset($estagio['Estagiario']['Supervisor']['cres']) ? $estagio['Estagiario']['Supervisor']['cress'] : "Sem dados" ?></td>
    ...
    <table class='table table-bordered' style="border: 1px; width: 100%; background-color: white;">
        <thead class="thead-light">
            <tr>
                <th><?= 'Dia'; ?></th>
                <th><?= 'Início'; ?></th>
    ...
    <table class="table" style="width: 100%; background-color: white;">
        <tr>
            <td><span style="font-size: 100%; text-decoration: overline">Coordenação de Estágio</span></td>
            <td><span style="font-size: 100%; text-decoration: overline"><?= $estagio["Estagiario"]["Aluno"]["nome"] ?></span></td>
            <td><span style="font-size: 100%; text-decoration: overline"><?= $estagio['Estagiario']['Supervisor']['nome'] ?></span></td>
        </tr>

        <tr>
            <td></td>
            <td><span style="font-size: 100%">DRE: <?= $estagio["Estagiario"]["Aluno"]["registro"] ?></span></td>
            <td><span style="font-size: 100%">CRESS 7ª Região: <?= $estagio['Estagiario']['Supervisor']['cress'] ?></span></td>
        </tr>
    </table>
</div>
