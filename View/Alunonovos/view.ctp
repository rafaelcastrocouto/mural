...
<div class='container'>
    ...
    <div class="row">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#estudante" role="tab" aria-controls="Instituição" aria-selected="true">Estudante</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#inscricoes" role="tab" aria-controls="Inscrições para seleção de estágio" aria-selected="false">Inscrições para seleção</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#estagios" role="tab" aria-controls="Estágios cursados" aria-selected="false">Estágios cursados</a>
            </li>
        </ul>
    </div>
            ...
            <div id="estudante" class="tab-pane container fade show active">
                ...
                <table class='table table-striped table-hover table-responsive'>
                    ...
                    <tr style='text-align:left'>
                        <td style='text-align:left'>Nascimento: <?= isset($alunos['Alunonovo']['nascimento']) ? date('d-m-Y', strtotime($alunos['Alunonovo']['nascimento'])) : ""; ?></td>
