...
<script>
    ...
    $(document).ready(function () {
        ...
        var base_url = "<?= $this->Html->url(array('controller' => 'Supervisors', 'action' => 'email')); ?>";
        /* alert(base_url); */

        $("#EstagiarioPeriodo").change(function () {
            var periodo = $(this).val();
            /* alert(periodo); */
            window.location = base_url + "/email/periodo:" + periodo;
        })
                ...
                <?php if ($aluno['Alunonovo']['email']): ?>
                    <tr>
                        <td style='text-align:left'>
                            <?php echo '"' . $aluno['Alunonovo']['nome'] . '" ' . htmlspecialchars('<') . $aluno['Alunonovo']['email'] . htmlspecialchars('>') . ', '; ?>
                        </td>
                    </tr>
