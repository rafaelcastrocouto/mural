<?php
// pr($estagiorealizado);
$estudante = trim($estagiorealizado['Aluno']['nome']);
$cpf = $estagiorealizado['Aluno']['cpf'];
$identidade = $estagiorealizado['Aluno']['identidade'];
$orgao = strtoupper($estagiorealizado['Aluno']['orgao']);
$registro = $estagiorealizado['Aluno']['registro'];
...
$horas = $estagiorealizado['Estagiario']['ch'];
if (empty($horas)) {
    $horas = '_____';
}
// die();
...
<body style="margin: 30px">
    ...
    <p style="text-align:justify; line-height: 2.5;">
        Declaramos que o/a estudante <b><?= $estagiorealizado['Aluno']['nome']; ?></b> 
        inscrito(a) no CPF sob o nº <?= $estagiorealizado["Aluno"]["cpf"]; ?> 
        e no RG nº <?= $estagiorealizado["Aluno"]["identidade"]; ?> 
        expedido por <?= $estagiorealizado["Aluno"]["orgao"]; ?>, 
        matriculado(a) no Curso de Serviço Social da 
        Universidade Federal do Rio de Janeiro com o número <?= $estagiorealizado["Aluno"]["registro"]; ?>, 
        estagiou na instituição <b><?= $estagiorealizado["Instituicao"]["instituicao"]; ?></b>, 
        com a supervisão profissional do/a Assistente Social <b><?= $supervisora; ?></b> 
        registrada no CRESS <?= $estagiorealizado["Supervisor"]["regiao"]; ?>&ordf; região 
        com o número <?= $estagiorealizado["Supervisor"]["cress"]; ?>, 
        no semestre de <?= $estagiorealizado["Estagiario"]["periodo"]; ?>, 
    ...
    <table style="width:100%">
        <tr>
            ...
            <td style="text-decoration: overline;"><?= $estagiorealizado["Aluno"]["nome"] ?></td>
            <td style="text-decoration: overline;"><?= $estagiorealizado["Supervisor"]["nome"] ?></td>
        </tr>

        <tr>
            <td>Escola de Serviço Social</td>
            <td>DRE: <?= $estagiorealizado["Aluno"]["registro"]; ?></td>
            <td>CRESS: <?= $estagiorealizado["Supervisor"]["cress"]; ?> da <?= $estagiorealizado["Supervisor"]["regiao"]; ?>&ordf; Região</td>
        </tr>
