...
// pr($proximo_nivel);
// pr($estagiarios);
// pr($estagiarios[count($estagiarios)-1]['Aluno']['id']);
?>
...
<?php echo $this->Form->input('Estagiario.id_aluno', array('type' => 'hidden', 'value' => $estagiarios[count($estagiarios) - 1]['Aluno']['id'])); ?>
