...
<div class='table-responsive'>
    ...
    <h1>Cadastro de usuário da(o) professora(o)</h1>
    ...
    echo $this->Form->input('professor_id', ['options' => $professores, 'empty' => 'Seleciona', 'required']);
    echo $this->Form->input('siape', ['value' => $siape, 'readonly']);
...
// echo $this->Form->input('sexo', array('options'=>array('1'=>'Masculino', '2'=>'Feminino')));
    ...
    echo $this->Form->input('email', ['value' => $email, 'readonly']);
