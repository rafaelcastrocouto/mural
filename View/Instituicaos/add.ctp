...
<div class='table-responsive'>
    ...
    . "<div class='col-8'>"
    . "<input list='instituicoes' name= 'data[Instituicao][instituicao]' id='InstituicaoInstituicao' class='form-control' maxlength='120'></input>"
    ...
    echo $this->Form->input('url', array('label' => ['text' => 'Endereço na internet (inclua o protocolo: http://)', 'class' => 'col-4 control-label']));
    echo $this->Form->input('convenio', array('label' => ['text' => 'Número de convênio na UFRJ', 'class' => 'col-4 control-label'], 'default' => 0));
    echo $this->Form->input('expira', array('label' => ['text' => 'Expira', 'class' => 'col-4 control-label'], 'dateFormat' => 'DMY', 'monthNames' => $meses, 'between' => "<div class = 'form-inline col-8'>"));
    echo $this->Form->input('seguro', array('options' => array('0' => 'Não', '1' => 'Sim')));
    echo $this->Form->input('area_instituicoes_id', array('label' => ['text' => 'Área da Instituição (não é a área da OTP)', 'class' => 'col-4 control-label'], 'options' => $id_area_instituicao, 'empty' => true));
    // echo $this->Form->input('natureza');

    echo "<div class='form-group row' form-type='text'>"
    . "<label class='col-4 control-label'>Natureza</label>"
    . "<div class='col-8'>"
    . "<input list='naturezas' name= 'data[Instituicao][natureza]' id='InstituicaoNatureza' class='form-control' maxlength='50'></input>"
    ...
    . "<div class='col-8'>"
    . "<input list='bairros' name= 'data[Instituicao][bairro]' id='InstituicaoBairro' class='form-control' maxlength='30'></input>"
    ...
    echo $this->Form->input('municipio', ['label' => ['text' => 'Município', 'class' => 'col-4 control-label']]);
    ...
    echo $this->Form->input('observacoes', array('label' => ['text' => 'Observações', 'class' => 'col-4 control-label'], 'type' => 'textarea', array('rows' => 5, 'cols' => 60)));
    ?>
