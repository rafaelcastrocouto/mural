...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#InstituicaoInstituicao").autocomplete(url_listainstituicao, {maxItemsToShow: 5});
...
<div class='table-responsive'>
    ...
    echo $this->Form->input('url', array('label' => ['text' => 'Endereço na internet (inclua o protocolo: http://)', 'class' => 'col-4']));
    echo $this->Form->input('convenio', array('label' => ['text' => 'Número de convênio na UFRJ', 'class' => 'col-4'], 'default' => 0));
    echo $this->Form->input('expira', array('label' => ['text' => 'Expira', 'class' => 'col-4'], 'dateFormat' => 'DMY', 'monthNames' => $meses, 'between' => "<div class = 'form-inline col-8'>"));
    echo $this->Form->input('seguro', array('options' => array('0' => 'Não', '1' => 'Sim')));
    echo $this->Form->input('area_instituicoes_id', array('label' => ['text' => 'Área da Instituição (não é a área da OTP)', 'class' => 'col-4'], 'options' => $id_area_instituicao, 'empty' => true));
