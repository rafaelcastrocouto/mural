    ...
    <div style='font-size: 90%', class='collapse navbar-collapse' id='navbarPrincipal'>
        <ul class="navbar-nav mr-auto">
            ...
            <?php if ($this->Session->read('categoria')): ?>
                ...
                <li class="nav-item">
                    <?php echo $this->Html->link("Instituições", "/Instituicaos/index", ['escape' => FALSE, 'class' => 'nav-link', 'style' => 'background-color: #2b6c9c; color: white']); ?>
                </li>
                <li class="nav-item">
            ...
            <?php if ($this->Session->read('id_categoria') == '1'): ?>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <?php echo $this->Html->link('Modalidade período especial', '/Complementos/index/', ['class' => 'dropdown-item', 'style' => 'background-color: #2b6c9c; color: white']); ?>
