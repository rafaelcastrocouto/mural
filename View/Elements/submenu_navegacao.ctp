        ...
        <ul class="navbar-nav mr-auto">
            ...
            switch ($this->Session->read('id_categoria')) {
                case 1: // Administrador
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <?php echo $this->Html->link("Formulário de atividades on-line", "/folhadeatividades/busca_dre", ['class' => 'dropdown-item', 'style' => 'background-color: #2b6c9c; color: white']); ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <?php echo $this->Html->link('Usuários', '/Users/index/', ['class' => 'dropdown-item', 'style' => 'background-color: #2b6c9c; color: white']); ?>
                ...
                case 2: // Estudante
                    ...
                    <li class="nav-item">
                        <?php echo $this->Html->link("Declaração de estágio", "/Estagiarios/view?registro=" . $this->Session->read('numero'), ['class' => 'nav-link', 'style' => 'background-color: #2b6c9c; color: white']); ?>
                    </li>
                    <li class="nav-item">
                ...
                case 4: // Supervisor
                    ?>
                    <li class="nav-item">
                        <?php echo $this->Html->link("Declaração de estágio", "/Alunos/busca_dre", ['class' => 'nav-link', 'style' => 'background-color: #2b6c9c; color: white']); ?>
                    </li>
                    <li class="nav-item">
                        <?php echo $this->Html->link("Folha de atividades", "/Alunos/folhasolicita", ['class' => 'nav-link', 'style' => 'background-color: #2b6c9c; color: white']); ?>
                    </li>
