...
<h2 style="text-align:center; line-height: 90%;">
...
<br />
<span style="font-size: 80%">Folha de ativiades do(a) estagiário(a)</span><br> 
<span style="font-size: 80%">Mês: __________ Ano: __________</span>
</h2>
...
Supervisor de campo: <?= $supervisor; ?> CRESS: <?= $cress; ?> Celular: <?= $celular; ?><br />
...
<table style="text-align:center;">
                <tr>
                    <td style="width:1%">Dia
                    </td>
                    <td style="width:4%">Horário
                    </td>
                    <td style="width:95%">Resumo das atividades
                    </td>
                </tr>
...
<tr class="auxiliar">
<td class="auxiliar"><span style="font-size: 90%; text-decoration: overline">Coordenação de Estágio</span></td>
<td class="auxiliar"><span style="font-size: 90%; text-decoration: overline"><?= $estudante; ?></span></td>
<td class="auxiliar"><span style="font-size: 90%; text-decoration: overline"><?= $supervisor; ?></span></td>
</tr>

<tr class="auxiliar">
<td class="auxiliar"></td>
<td class="auxiliar"><span style="font-size: 90%">DRE: <?= $registro; ?></span></td>
<td class="auxiliar"><span style="font-size: 90%">CRESS 7ª Região: <?= $cress; ?></span></td>
</tr>
</table>
