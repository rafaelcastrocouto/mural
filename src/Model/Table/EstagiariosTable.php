...
class EstagiariosTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['id'], 'Alunos'), ['errorField' => 'aluno_id']);
        $rules->add($rules->existsIn(['id'], 'Instituicoes'), ['errorField' => 'instituicao_id']);
        $rules->add($rules->existsIn(['id'], 'Supervisores'), ['errorField' => 'supervisor_id']);
        $rules->add($rules->existsIn(['id'], 'Professores'), ['errorField' => 'professor_id']);
        $rules->add($rules->existsIn(['id'], 'Inscricoes'), ['errorField' => 'inscricao_id']);
        $rules->add($rules->existsIn(['id'], 'Turmas'), ['errorField' => 'turma_id']);
        $rules->add($rules->existsIn(['id'], 'Turnos'), ['errorField' => 'turno_id']);
