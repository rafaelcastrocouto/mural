...
class ProfessorPolicy implements BeforePolicyInterface
{
  ...
  public function canEdit(IdentityInterface $userSession, Professor $userData)
  {
  ...
  public function canDelete(IdentityInterface $userSession, Professor $userData)
  {
    return new Result(false, 'Erro: professor delete policy not allowed');
  }

  
  protected function sameUser(IdentityInterface $userSession, Professor $userData)
  {
