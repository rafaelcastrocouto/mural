...
<div class="container">
    ...
    <table class='table table-bordered' style="border: 1px; width: 90%; background-color: white;">
        ...
        <tbody>
            <?php $seconds = NULL; ?>
            <?php foreach ($atividades as $c_atividade): ?>
                <tr>
                    <td><?php echo date('d-m-Y', strtotime($c_atividade->dia)); ?>&nbsp;</td>
                    <td><?php echo $c_atividade->inicio; ?>&nbsp;</td>
                    <td><?php echo $c_atividade->final; ?>&nbsp;</td>
                    <td><?php echo $c_atividade->horario; ?>&nbsp;</td>
                    <td><?php echo $c_atividade->atividade; ?>&nbsp;</td>
                </tr>
                <?php
                list($hour, $minute, $second) = array_pad(explode(':', $c_atividade->horario), 3, null);
    ...
    <table class="table" style="width: 100%; background-color: white;">
        <tr>
            <td style="width: 33%"><span style="font-size: 100%; text-decoration: overline">Coordenação de
                    Estágio</span></td>
            <td style="width: 33%"><span
                    style="font-size: 100%; text-decoration: overline"><?= $estagiario->aluno->nome ?></span></td>
            <td style="width: 33%"><span style="font-size: 100%; text-decoration: overline"><?= $supervisora ?></span>
            </td>
        </tr>
